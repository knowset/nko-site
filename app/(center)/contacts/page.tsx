            ...
            <div className="flex flex-col gap-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
                    <div className="flex flex-col items-center p-8">
                        <Image width={64} height={64} alt="" src="/contacts_homepic.png" />
                        <h1 className="mt-4 text-lg font-bold">Наш адрес</h1>
                        <p className="text-center">160000, Вологда, улица Ленина, дом 15 (каб.332)</p>
                    </div>
                    <div className="flex flex-col items-center p-8">
                        <Image width={64} height={64} alt="" src="/contacts_emailpic.png" />
                    ...
                    <div className="flex flex-col items-center p-8">
                        ...
                        <h1 className="mt-4 text-lg font-bold">Социальные сети</h1>
                        <Link className="text-center" href="https://vk.com/nko_vogu">https://vk.com/nko_vogu</Link>
                    </div>
                </div>
            </div>
        </div>

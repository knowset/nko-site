export const navlinks: {
    ...
    },
    {
        ...
        links: [
            ...
            { title: "Услуги", href: "/nko/services" },
...
export const service_learning_page_items: {
    ...
    },
    {
        ...
        text: "Ежегодное формирование «социального заказа» для образовательного модуля «Социальное проектирование» на учебный год",
    },
    {
...
export const for_students_services_page_items: {
    ...
    },
    {
        ...
        list_items: [
            ...
            "Распространение информации о реализуемых студенческих  проектах",
        ],
    },
];

export const nko_services_page_items: {
    picture: string;
    title: string;
    list_items: string[];
}[] = [
    {
        picture: "/nko/services/1.png",
        title: "Подготовка заявок на гранты",
        list_items: [
            "Экспертная оценка социальной идеи для потенциального участия в конкурсе",
            "Консультации по оформлению заявки на конкурс, в т.ч. регистрации на порталах",
            "Помощь в формировании отчетности по гранту",
        ],
    },
    {
        picture: "/nko/services/2.png",
        title: "Обучение социальному проектированию",
        list_items: [
            "Организация обучающих программ по социальному проектированию",
            "Практические занятия: акселераторы, тренинги",
            "Индивидуальные консультации по доработке проектов",
        ],
    },
    {
        picture: "/nko/services/3.png",
        title: "Методическая поддержка",
        list_items: [
            "Подготовка методических материалов по социальному проектированию",
            "Предоставление нормативных актов в области работы НКО и социального проектирования",
        ],
    },
    {
        picture: "/nko/services/4.png",
        title: "Техническая поддержка",
        list_items: [
            "Информирование о предстоящих грантах",
            "Содействие в обеспечении помещениями, техническими средствами для реализации проектов",
        ],
    },
    {
        picture: "/nko/services/5.png",
        title: "Коммуникационная поддержка",
        list_items: [
            "Проведение семинаров, встреч с победителями грантовых конкурсов в сфере молодежной политики",
            "Обобщение и тиражирование успешных практик социальных технологий в молодежной среде",
        ],
    },
    {
        picture: "/nko/services/6.png",
        title: "Информационная поддержка",
        list_items: [
            "Регулярное освещение в социальных сетях общественно-значимых мероприятий НКО-партнеров",
            "Распространение информации об НКО-партнерах и реализуемых проектах",
        ],
    },
];
